...
export function WorkspaceSparkline({ cell, measurements, patientId, label, domain, fit }: {
  ...
  return <svg className="wt-sparkline" viewBox="0 0 218 85" role="img" aria-label={`Measurement trajectory for patient ${patientId}, ${label}: ${cell.points.length} measurements; shared scale, days since first measurement`}>
